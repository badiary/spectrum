...
!(function (e, t) {
    ...
    if (t.scope === n || "all" === t.scope) {
      for (var i in ((o = 0 < t.mods.length), m))
        Object.prototype.hasOwnProperty.call(m, i) &&
          ((!m[i] && ~t.mods.indexOf(+i)) || (m[i] && !~t.mods.indexOf(+i))) &&
          (o = !1);
      ((0 !== t.mods.length || m[16] || m[18] || m[17] || m[91]) &&
        !o &&
        "*" !== t.shortcut) ||
        (!1 === t.method(e, t) &&
  ...
  function b(n) {
    ...
    if (x.filter.call(this, n)) {
          ...
          n[e] && !~v.indexOf(t)
            ...
            : "metaKey" === e &&
              ...
              (n.ctrlKey ||
                n.shiftKey ||
                n.altKey ||
                (v = v.slice(v.indexOf(t))));
        }),
        t in m)
      ) {
        for (var o in ((m[t] = !0), y)) y[o] === t && (x[o] = !0);
        if (!e) return;
      }
      for (var i in m)
      ...
      n.getModifierState &&
        ...
        (~v.indexOf(17) || v.push(17),
        ~v.indexOf(18) || v.push(18),
        (m[17] = !0),
        (m[18] = !0));
      var r = O();
      if (e)
        for (var f = 0; f < e.length; f++)
          e[f].scope === r &&
            (("keydown" === n.type && e[f].keydown) ||
              ("keyup" === n.type && e[f].keyup)) &&
            K(n, e[f], r);
      if (t in g)
        for (var a = 0; a < g[t].length; a++)
          if (
            (("keydown" === n.type && g[t][a].keydown) ||
              ("keyup" === n.type && g[t][a].keyup)) &&
            g[t][a].key
          ) {
            for (
              var c = g[t][a], l = c.key.split(c.splitKey), s = [], u = 0;
              u < l.length;
              u++
            )
              s.push(k(l[u]));
      ...
      u(f, "keyup", function (e) {
        b(e),
          (function (e) {
            ...
            if (
              (n < 0 || v.splice(n, 1),
              e.key && "meta" == e.key.toLowerCase() && v.splice(0, v.length),
              (t = 93 === t || 224 === t ? 91 : t) in m)
            )
              for (var o in ((m[t] = !1), y)) y[o] === t && (x[o] = !1);
          })(e);
      }));
  }
  var i,
    ...
    c = {
      ...
      filter: function (e) {
        ...
        return !t.isContentEditable &&
          (("INPUT" !== e && "TEXTAREA" !== e && "SELECT" !== e) || t.readOnly)
          ? !0
          : !1;
      },
      unbind: function (e) {
        if (e) {
          if (Array.isArray(e))
          ...
          else if ("object" == typeof e) e.key && f(e);
            ...
            "function" == typeof i && ((r = i), (i = "")),
              f({ key: e, scope: i, method: r, splitKey: "+" });
          }
        } else
  ...
  for (i in c) Object.prototype.hasOwnProperty.call(c, i) && (x[i] = c[i]);
  return (
